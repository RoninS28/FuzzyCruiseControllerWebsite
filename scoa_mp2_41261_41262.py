# -*- coding: utf-8 -*-
"""SCOA_MP2_41261.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KDiu2qqt4pm1Isx9JidGEz8hdytrJo4s
...
class CruiseController:
    def __init__(self):
        ...
        self.throttle_base = self.throttle_vals['PL'] - \
            self.throttle_vals['ZE']
    ...
    def __crisp_to_fuzzy(self, val, mf):
        ...
        for x, myu_x in mf.items():
            if myu_x(val) > 0:
                fuzzy_values.append((x, myu_x(val)))
        return fuzzy_values
    ...
    def __defuzzify(self, throttle_fuzzy):
        ...
        for tf in throttle_fuzzy:
            areas.append(
                (self.throttle_vals[tf[0]], self.__get_throttle_area(tf[1])))
        throttle = 0
        total_area = 0
        for a in areas:
            throttle += a[0] * a[1]
